...
export default function Hero() {
  return (
    <section className="relative w-full min-h-[700px] md:min-h-[700px] lg:min-h-screen bg-[#303030] flex items-center justify-center px-6 overflow-hidden mt-24 py-4 md:py-0 md:mt-12 xl:mt-0">
      <div className="max-w-7xl w-full flex flex-col lg:flex-row items-center justify-between gap-10 px-4 lg:px-8 relative">
        ...
        {/* Right Image Section */}
        <div className="w-full max-w-[800px] lg:flex-1 flex items-center justify-center relative order-1 lg:order-2">
          
          {/* Enhanced Mobile/Tablet Image - Simple but prominent */}
          <div className="lg:hidden w-full max-w-[500px] mx-auto">
            <div className="relative aspect-square w-full rounded-full overflow-hidden border-4 border-[#ffde4f] shadow-xl">
              <Image 
                src="/jeremy.png"
                alt="Jeremy"
                fill
          ...
          {/* Desktop Image - Completely unchanged */}
          <div className="hidden lg:block absolute -bottom-[350px] md:right-10 md:-top-[600px] lg:-right-40 lg:-top-[700px] z-10">
            <div className="lg:w-[800px] lg:h-[1600px] rounded-lg overflow-hidden shadow-lg flex items-center justify-center">
              <Image 
                src="/jeremy.png" 
                alt="Jeremy" 
                width={800}
