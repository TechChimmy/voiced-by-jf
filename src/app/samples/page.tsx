    ...
    <>
      ...
      <div className="page-grain relative h-screen overflow-hidden f-dm flex flex-col"
        ...
        <div className="relative z-10 max-w-[1400px] w-full mx-auto px-6 xl:px-16 py-5
          ...
          {/* ════ LEFT: TRACK LIST ════ */}
          <div className={`xl:flex w-full xl:w-[520px] flex-shrink-0 flex-col min-h-0 h-full ${mobileShowVideo ? 'hidden xl:flex' : 'flex'}`}>
                    ...
                    <div className="flex items-center gap-4 px-5 py-5">
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-2 mb-1 flex-wrap">
                          ...
                          <span className="f-dm text-[12px]" style={{ color:'rgba(255,255,255,0.28)' }}>
                            {s.duration}
                          </span>
                        </div>
                        <p className="f-dm font-light text-[13px] leading-relaxed line-clamp-1"
                          style={{ color:'rgba(200,191,160,0.42)' }}>
                          {s.description}
                        </p>
                      </div>
          ...
          {/* ════ RIGHT: VIDEO MONITOR ════ */}
          <div className={`xl:flex w-full xl:flex-1 flex-col gap-3 min-h-0 h-full ${mobileShowVideo ? 'flex' : 'hidden xl:flex'}`}>

            {/* Mobile back button — only visible when video is showing on mobile */}
            <button
              className="xl:hidden flex items-center gap-2 self-start mb-1 flex-shrink-0"
            ...
            >
              ...
              <span className="f-tenor text-[10px] tracking-[0.18em] uppercase" style={{ color }}>
                Back to Tracks
              </span>
            </button>
            ...
            {currentSample ? (
              <div className="fade-in flex items-center gap-3 px-5 py-4 rounded-2xl flex-wrap"
                ...
                {/* Description */}
                <p className="f-dm font-light flex-1 min-w-0 line-clamp-1"
                  style={{ fontSize:'12px', color:'rgba(200,191,160,0.38)' }}>
